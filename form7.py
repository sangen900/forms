...
#                 form_data4 = {
#                             'Title1': text_titles1,
#                             'selected option1': selected_option08,
#                             'Title2': text_titles2,
#                             'selected option2': selected_option09
#                         }
#                 num_rows = len(worksheet.get_all_values())
#                 worksheet.insert_rows([list(form_data4.values())], num_rows+1)
...
def form_7():
    with st.form("form7"):
        ...
        selected_options1 = []  # Create a list to store selected options for text_titles1
        ...
        selected_options2 = []  # Create a list to store selected options for text_titles2
