...
#         css_style = f"font-size: 20px;"
#         for statements, key in statements00:
#             st.markdown(f'<div style="{css_style}">{statement}:</div>', unsafe_allow_html=True)
#             selected_option34 = st.radio("", ["Apply", "Do NOT apply"], key=key)
#             st.markdown("---")
#         st.markdown(
#             """
...
# # return selected_option23, selected_option45, selected_option56,  selected_option34, selected_option49
...
def form_8():
    with st.form("form8"):
        ...
        selected_options1 = []  # Create a list to store selected options for text_statements1
