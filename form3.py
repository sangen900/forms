...
# def form_3():
#     selected_age, selected_option_q40, other_input_gender, selected_option_q41, other_input_race, selected_gpa,selected_option, other_input_college, selected_concentration, other_input_major, other_input_college = "",other_input_race = ""
#     st.markdown(
#         """
...
#         unsafe_allow_html=True
#     )
#     selected_concentration = st.radio("", ["Engineering (list specific concentration)"], key= "selected_concentration5")
#     other_input_major = ""
...
#             warnings = []
#             if not selected_age:
#                 warnings.append("select your age")
#             if not selected_option_q40:
#                 warnings.append("Please select your gender")
#             if not selected_option_q41:
#                 warnings.append("please specify your race/ethnicity.")
#             if not selected_gpa:
#                 warnings.append("Please specify your gpa")
#             if not selected_option:
#                 warnings.append("Please specify your college major.")
            
#             if warnings:
#                 st.warning("\n".join(warnings))
#             else:
#                 st.success(f"form3 has been successfully submitted")
